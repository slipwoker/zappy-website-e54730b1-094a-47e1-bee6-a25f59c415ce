document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function showError(field, message) {
      ...
      parent.insertBefore(errorEl, field.nextSibling);
    }
    ...
    function validateField(field) {
      ...
      if (value.trim() !== '') {
        ...
        if (
          ...
          !VALIDATORS.minlength(value, field.dataset.minlength)
        ) {
  ...
  const ANIMATION_SELECTOR = '.fade-in, .scroll-animate, [data-animate]';
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "טבע הבריאה - ריפוי טבעי משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'e54730b1-094a-47e1-bee6-a25f59c415ce',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'e54730b1-094a-47e1-bee6-a25f59c415ce';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'e54730b1-094a-47e1-bee6-a25f59c415ce';
